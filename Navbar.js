...
export default function Navbar(props) {
  ...
  <input className="form-check-input" onClick={()=>{props.toggleMode(null)}} type="checkbox"  id="fileSwitchCheckDefault"/>
  <label className="form-check-label" htmlFor="fileSwitchCheckDefault">Toggle Mode</label>
</div>
    </div>
  </div>
</nav>
